...
import com.taxi.chat.adapter.ChatFirebaseAdapter;
import com.taxi.chat.adapter.ClickListenerChatFirebase;
import com.taxi.chat.model.ChatModel;
import com.taxi.chat.model.FileModel;
import com.taxi.chat.model.MapModel;
import com.taxi.chat.model.UserModel;
...
//        startActivity(intent);
            ...
            uploadTask.addOnFailureListener(new OnFailureListener() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    storageReference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            Log.i(TAG,"onSuccess sendFileFirebase");
                            FileModel fileModel = new FileModel("img",uri.toString(),file.getName(),file.length()+"");
                            ChatModel chatModel = new ChatModel(userModel,"",Calendar.getInstance().getTime().getTime()+"",fileModel);
                            mFirebaseDatabaseReference.child(CHAT_REFERENCE).push().setValue(chatModel);
                        }
                    });
    ...
    private void verifyUserLogin(){
        ...
        if (mFirebaseUser == null){
            ...
            userModel = new UserModel(name, photo_url, mFirebaseUser.getUid() );
