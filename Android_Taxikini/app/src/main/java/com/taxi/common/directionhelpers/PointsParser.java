...
import com.taxi.common.directionhelpers.DataParser;
...
public class PointsParser extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
    ...
    public PointsParser(Context context, Fragment fragment, String directionMode) {
    ...
    protected void onPostExecute(List<List<HashMap<String, String>>> result) {
        ...
        if (result.size() == 0) {
            Toast.makeText(mContext, "Invalid directions", Toast.LENGTH_LONG).show();
        }
