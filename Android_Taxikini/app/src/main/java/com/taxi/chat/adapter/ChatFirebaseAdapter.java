...
//            Glide.with(ivUser.getContext()).load(urlPhotoUser).centerCrop().transform(new CircleTransform1(ivUser.getContext())).override(40,40).into(ivUser);
